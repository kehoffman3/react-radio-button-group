...
var getNonEmptyAttr = exports.getNonEmptyAttr = function getNonEmptyAttr(name, value) {
  return value ? _defineProperty({}, name, value) : {};
};
var selectStringParam = exports.selectStringParam = function selectStringParam() {
...
var _reactRadioButton = __webpack_require__(13);

var _reactRadioButton2 = _interopRequireDefault(_reactRadioButton);
...
var ReactRadioButtonGroup = function (_React$Component) {
    _inherits(ReactRadioButtonGroup, _React$Component);

    _createClass(ReactRadioButtonGroup, [{
    ...
    function ReactRadioButtonGroup(props) {
        _classCallCheck(this, ReactRadioButtonGroup);

        var _this = _possibleConstructorReturn(this, (ReactRadioButtonGroup.__proto__ || Object.getPrototypeOf(ReactRadioButtonGroup)).call(this, props));

        _this.id = ReactRadioButtonGroup.generateId();
    ...
    _createClass(ReactRadioButtonGroup, [{
        ...
        key: 'createStateFromEvent',
        value: function createStateFromEvent(event) {
            return {
        ...
        key: 'fireOnChange',
        value: function fireOnChange(param) {
            if (this.props.onChange) {
                this.props.onChange(param);
            }
        }
    }, {
        key: 'fireCurrentState',
        value: function fireCurrentState() {
            this.fireOnChange(this.state.currentValue);
        }
    }, {
        key: 'fireEventValue',
        value: function fireEventValue(event) {
            this.fireOnChange(event.target.value);
        }
    }, {
        key: 'willStateChange',
        value: function willStateChange(oldState, newState) {
        ...
        value: function handleChange(event) {
            if (this.isStateful()) {
                var newState = this.createStateFromEvent(event);
        ...
        key: 'getIsValueChecked',
        value: function getIsValueChecked(value) {
            return this.isStateful() && this.state.currentValue === value || !this.isStateful() && this.props.value === value;
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var groupId = this.getComponentName() + '-' + this.id;

            return _react2.default.createElement(
                'div',
                (0, _util.getNonEmptyAttr)(CLASS_NAME, groupClassName),
                this.props.options.map(function (option, i) {
                    var value = (0, _util.selectStringParam)(option, option.value);
                    return _react2.default.createElement(_reactRadioButton2.default, { key: i,
                        name: _this2.props.name,
                        value: value,
                        inputType: _this2.getInputType(),
                        isChecked: _this2.getIsValueChecked(value),
                        groupId: groupId,
                        option: option,
                        ...
                        itemClassName: _this2.props.itemClassName
                    });
                })
            );
        }
...
ReactRadioButtonGroup.generateId = function () {
    return ReactRadioButtonGroup.idGenerator++;
};
...
var m=__webpack_require__(3),n=__webpack_require__(7),p=__webpack_require__(1),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.portal"):60106,u=q?Symbol["for"]("react.fragment"):60107,v=q?Symbol["for"]("react.strict_mode"):60108,w=q?Symbol["for"]("react.provider"):60109,x=q?Symbol["for"]("react.context"):60110,y=q?Symbol["for"]("react.async_mode"):60111,z=q?Symbol["for"]("react.forward_ref"):60112,A="function"===
...
var getUniqueId = exports.getUniqueId = function getUniqueId(groupId, value) {
    return groupId + '-' + value;
};

var CLASS_NAME = 'className';

var ReactRadioButton = function (_React$Component) {
    _inherits(ReactRadioButton, _React$Component);

    function ReactRadioButton() {
        _classCallCheck(this, ReactRadioButton);

        return _possibleConstructorReturn(this, (ReactRadioButton.__proto__ || Object.getPrototypeOf(ReactRadioButton)).apply(this, arguments));
    }

    _createClass(ReactRadioButton, [{
        key: 'render',
        value: function render() {
            var option = this.props.option;

            var label = (0, _util.selectStringParam)(option, option.label, this.props.value);

            var itemClassName = (0, _util.selectStringParam)(option.itemClassName, this.props.itemClassName, '');
            var inputClassName = (0, _util.selectStringParam)(option.inputClassName, this.props.inputClassName, '');
            var labelClassName = (0, _util.selectStringParam)(option.labelClassName, this.props.labelClassName, '');

            var inputId = getUniqueId(this.props.groupId, this.props.value);
            var defaultValue = this.props.defaultValue ? { defaultValue: this.props.defaultValue } : {};

            return _react2.default.createElement(
                'div',
                (0, _util.getNonEmptyAttr)(CLASS_NAME, itemClassName),
                _react2.default.createElement('input', _extends({ type: this.props.inputType,
                    checked: this.props.isChecked,
                    id: inputId,
                    onChange: this.props.onChange
                }, (0, _util.getNonEmptyAttr)(CLASS_NAME, inputClassName), {
                ...
                _react2.default.createElement(
                    ...
                    _extends({
                        htmlFor: inputId
                    }, (0, _util.getNonEmptyAttr)(CLASS_NAME, labelClassName)),
                    label
                )
            );
        }
    ...
    return ReactRadioButton;
}(_react2.default.Component);

exports.default = ReactRadioButton;
